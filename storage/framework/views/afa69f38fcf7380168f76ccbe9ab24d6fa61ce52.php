...
<html>
    <head>
        ...
        <!-- Google Font -->
        <link rel="stylesheet" href="<?php echo e(asset('https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic.css')); ?>">
        <style>
            .ar{
                direction: rtl;
            }
            .ar.checkbox label, .ar .radio label {
                padding-right: 20px;
            }
            .ar .radio input{
                margin-right: -20px;
    ...
    <?php echo $__env->make('template.adminHeader', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <?php echo $__env->make('template.adminSidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->yieldContent('content'); ?>

    <?php echo $__env->make('template.adminFooter', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>